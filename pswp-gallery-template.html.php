...
<figure class="pwpswp-gallery__item" itemprop="associatedMedia" itemscope itemtype="http://schema.org/ImageObject">
    <a class="pwpswp-gallery__link" href="<?= $image->url ?>" itemprop="contentUrl" data-size="<?= $image->width ?>x<?= $image->height ?>" data-lores-src="<?= $lowresImage->url ?>">
        <img class="pwpswp-gallery__image" src="<?= $thumbnailImage->url ?>" itemprop="thumbnail" alt="<?= $image->description ?>" />
    </a>
